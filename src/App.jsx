...
export default function App() {
  const [loading, setLoading] = useState(true); // BOOT LOADER ⏳
  ...
  // Economy & Inventory (Defaults to empty array for safety)
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, async (u) => {
      ...
      if (!u) { 
        // DO NOT AUTO LOGIN. WAIT FOR USER. 🛡️
        return; 
      }
      setUser(u);

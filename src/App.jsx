...
// --- SETTINGS COMPONENT (MOVED OUTSIDE FOR STABILITY 🛡️) ---
    ...
    return (
      <div className="fixed inset-0 bg-black flex items-center justify-center overflow-hidden">
        ...
        <div className="w-full h-full flex items-center justify-center relative pointer-events-none">
            ...
            <div className="absolute bottom-8 right-8 flex gap-4 z-[100] pointer-events-auto">
    ...
    <div className="fixed inset-0 bg-[#0c0c14] text-white font-sans flex flex-col items-center overflow-hidden">
      ...
      <div className={`w-full max-w-sm px-4 flex-1 flex flex-col gap-4 pb-6 transition-all duration-1000 relative z-10 ${isChaosMode ? 'skew-x-6 rotate-2 blur-[1.5px] scale-95 opacity-80 brightness-75' : ''}`}>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <button onClick={toggleMic} className={`p-3.5 rounded-[25px] border border-white/5 flex flex-col items-center gap-1 active:scale-95 ${isInfinityMic ? 'bg-red-600/30 border-red-500/50 text-red-200' : 'bg-white/5 border-white/10 text-slate-400'}`}><Mic size={16}/><span className="text-[7px] uppercase font-bold tracking-widest">Mic</span></button>
        </div>
      </div>

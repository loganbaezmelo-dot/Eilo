...
export default function App() {
  ...
  const triggerPanicSpeech = (reason) => {
    ...
    const lines = reason === 'holding' 
      ...
      : [`Help me ${name}! I'm looking at the roof! 🎈`, `I'm falling! ✨`, `Everything is spinning! 🎀`];
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-[#0c0c14] text-white flex flex-col items-center justify-center p-6 text-center font-sans">
        <div className="w-full max-w-sm bg-[#161622] rounded-[50px] p-10 shadow-2xl border border-white/5 animate-in zoom-in duration-700">
            ...
            <p className="mt-8 text-[10px] text-slate-500 uppercase tracking-widest font-bold">Soul by Logan Baez</p>
        </div>
      </div>
    );
  }

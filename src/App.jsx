...
import { 
  Heart, Moon, Volume2, VolumeX, Send, Zap, Settings, X, Hand, AudioLines, Mic, ToggleLeft, ToggleRight, AlertTriangle, Eye, Camera, Sparkles, Ghost, Radio, Network, Cpu, ShieldCheck, LogOut, Coins, Laptop, ShoppingBag, ArrowUp, ArrowDown, Bandage, Lock
} from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 bg-[#0c0c14] text-white font-sans flex flex-col items-center overflow-hidden">
      ...
      <div className="w-full max-w-xl p-4 h-64 flex-shrink-0 relative">
        <div 
            onClick={handleFaceClick} // CLICK TO TAPE
